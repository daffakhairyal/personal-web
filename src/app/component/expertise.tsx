...
export default function Expertise(){
    return(
                <section className="relative bg-black w-full flex justify-center flex p-5 md:px-20 md:py-6 ">
                    <div className='w-full max-w-[1400px] flex flex-col pt-10'>
                        ...
                        <div className='grid grid-rows-1 md:grid-rows-2 md:grid-flow-col text-white  p-5 '>
                            ...
                            <div className='flex flex-col justify-center items-center p-5 gap-y-3'>
                                ...
                                <h1 className='text-amber-300 text-xl font-semibold'>Forecasting Business Trends</h1>
                            </div>
                            <div className=' flex flex-col justify-center items-center p-5 gap-y-3'>
                                <div className='object-cover w-full max-w-[200px] h-full max-h-[130px] relative flex items-center justify-center box-pattern'>
                                <Image
                            ...
                            <div className=' flex flex-col justify-center items-center p-5 gap-y-3'>
                                ...
                                <h1 className='text-amber-300 text-xl font-semibold'>Customized Solutions for Your Business</h1>
                            </div>
                        </div>
                    </div>
